...
function Footer({ onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-xl text-foreground mb-1", children: "Padma Home Food" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Fresh Veg & Non-Veg Specials" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-3 leading-relaxed", children: "Authentic home-cooked Andhra flavours, made with love in Hyderabad." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground mb-3", children: "Visit Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 15, className: "mt-0.5 shrink-0 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
              "Open daily:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "8:00 AM – 10:00 PM" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 15, className: "mt-0.5 shrink-0 text-primary" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 15, className: "mt-0.5 shrink-0 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Hyderabad, India" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground mb-3", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 text-sm", children: links.map(({ page, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "© ",
        year,
        " Padma Home Food. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
...
function Header({ page, onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary text-primary-foreground px-4 py-1.5 flex items-center justify-center gap-6 text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 13 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Open: 8:00 AM – 10:00 PM" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "hidden sm:flex items-center gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:9666817773", className: "hover:underline", children: "9666817773" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-lg font-display font-bold", children: "P" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-bold text-lg text-foreground", children: "Padma" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-semibold text-sm text-primary -mt-1", children: "Home Food" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-1", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `px-4 py-2 rounded-lg font-body font-medium text-sm transition-smooth ${page === link.page ? "bg-primary/10 text-primary" : "text-foreground hover:bg-muted hover:text-primary"}`,
          children: link.label
        },
        link.page
      )) }),
    ...
    isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card border-t border-border px-4 pb-4", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => {
        ...
        className: `flex w-full px-4 py-3 rounded-lg font-body font-medium text-base mt-1 transition-smooth ${page === link.page ? "bg-primary/10 text-primary" : "text-foreground hover:bg-muted"}`,
        children: link.label
      },
      link.page
    )) })
...
function Layout({ children, page, onNavigate }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { page, onNavigate }),
...
const menuItems = [
  {
    ...
    price: 50,
    category: "veg",
    imageUrl: "/assets/generated/idli.dim_600x500.jpg",
  ...
  },
  {
    ...
    price: 50,
    category: "veg",
    imageUrl: "/assets/generated/bonda.dim_600x500.jpg",
    description: "Crispy golden fried potato balls with green chutney"
  },
  {
    id: 3,
    name: "Dal",
    price: 60,
    category: "veg",
    imageUrl: "/assets/generated/dal.dim_600x500.jpg",
    description: "Slow-cooked toor dal tempered with ghee, mustard & curry leaves"
  },
  {
    id: 4,
    name: "Chicken Curry",
    price: 120,
    category: "nonveg",
    imageUrl: "/assets/generated/chicken-curry.dim_600x500.jpg",
    description: "Andhra-style bone-in chicken in rich spiced masala gravy"
  },
  {
    id: 5,
    name: "Chicken Fry",
    price: 199,
    category: "nonveg",
    imageUrl: "/assets/generated/chicken-fry.dim_600x500.jpg",
    description: "Bold dry-fried chicken with Andhra spice blend and curry leaves"
  },
  {
    id: 6,
    name: "Chapati",
    price: 30,
    category: "veg",
    imageUrl: "/assets/generated/chapati.dim_600x500.jpg",
    description: "Soft whole wheat flatbread, best paired with dal or curry"
  },
  {
    id: 7,
    name: "Lemon Rice",
    price: 60,
    category: "veg",
    imageUrl: "/assets/generated/lemon-rice.dim_600x500.jpg",
    description: "Tangy yellow rice with mustard, cashews and fresh curry leaves"
  },
  {
    id: 8,
    ...
    price: 69,
    category: "veg",
    imageUrl: "/assets/generated/mango-lemon-rice.dim_600x500.jpg",
    description: "Zesty rice with raw mango shreds, peanuts and tempered spices"
  },
  {
    id: 9,
    name: "Plain Dosa",
    price: 39,
    category: "veg",
    imageUrl: "/assets/generated/plain-dosa.dim_600x500.jpg",
    description: "Thin crispy rice crepe served with sambar and two chutneys"
  },
  {
    id: 10,
    name: "Karam Dosa",
    price: 49,
    category: "veg",
    imageUrl: "/assets/generated/karam-dosa.dim_600x500.jpg",
    description: "Crispy dosa with fiery red chili karam and onion stuffing"
  },
  {
    id: 11,
    name: "Onion Dosa",
    price: 49,
    category: "veg",
    imageUrl: "/assets/generated/onion-dosa.dim_600x500.jpg",
    description: "Golden dosa loaded with caramelized onions and spices"
  },
  {
    id: 12,
    name: "Egg Dosa",
    price: 69,
    category: "egg",
    imageUrl: "/assets/generated/egg-dosa.dim_600x500.jpg",
    description: "Crispy dosa topped with a fresh egg, pepper and spices"
  },
  {
    id: 13,
    name: "Ragi Dosa",
    price: 49,
    category: "veg",
    imageUrl: "/assets/generated/ragi-dosa.dim_600x500.jpg",
    description: "Nutritious finger millet dosa, crispy and lightly spiced"
  }
];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-6xl mx-auto px-4 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-center gap-1.5 text-primary-foreground/80 text-sm font-semibold uppercase tracking-widest mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-px bg-primary-foreground/50" }),
              " Hyderabad, India"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl sm:text-6xl font-bold text-primary-foreground leading-tight mb-3", children: [
              "Padma",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Home Food"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/90 text-lg mb-2 font-body", children: "Fresh Veg & Non-Veg Specials" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-primary-foreground/80 text-sm mb-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 15 }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "8:00 AM – 10:00 PM" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/50", children: "·" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Open Every Day" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:9666817773", children: "Call Us" })
                }
              )
            ] })
          ] }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-4 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:9666817773", className: "font-semibold hover:underline", children: "9666817773" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 16 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Hyderabad, India" })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 py-14", "data-ocid": "home.features_section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-center text-foreground mb-10", children: "Why Padma Home Food?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: [
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { size: 28, className: "text-accent" }),
          title: "Pure Veg Options",
          desc: "Fresh ingredients, zero compromise on quality and taste."
        },
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { size: 28, className: "text-primary" }),
          title: "Non-Veg Specials",
          desc: "Andhra-style chicken dishes packed with bold, authentic spice."
        },
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 28, className: "text-primary" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-14", "data-ocid": "home.popular_section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold text-foreground", children: "Popular Dishes" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4", children: highlights.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-1 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm text-foreground leading-snug line-clamp-2", children: item.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: item.category === "nonveg" ? "badge-nonveg" : "badge-veg",
                    style: { fontSize: "10px", padding: "2px 6px" },
                    children: item.category === "nonveg" ? "🔴" : "🟢"
                  }
                )
              ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold mb-2", children: "Hungry? Give Us a Call!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 mb-6", children: "We're open 8 AM to 10 PM every day. Call ahead for fresh hot food." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              asChild: true,
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:9666817773", children: "📞 Call 9666817773" })
            }
          )
        ] })
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-sm font-semibold uppercase tracking-widest mb-2", children: "Our Menu" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground mb-2", children: "Fresh Every Day" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-base max-w-md mx-auto", children: "Authentic Andhra home cooking — vegetarian and non-vegetarian dishes made with love." })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 border-b border-border sticky top-[108px] z-30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 py-3 flex gap-2 overflow-x-auto", children: FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => setFilter(f.value),
        "data-ocid": `menu.filter.${f.value}_tab`,
        className: `px-4 py-1.5 rounded-full text-sm font-semibold whitespace-nowrap transition-smooth border ${filter === f.value ? "bg-primary text-primary-foreground border-primary" : "bg-card text-foreground border-border hover:border-primary hover:text-primary"}`,
        children: f.label
      },
      f.value
    )) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-20", "data-ocid": "menu.empty_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg", children: "No items found for this filter." }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5", children: filtered.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-[4/3] overflow-hidden relative", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      borderColor: item.category === "nonveg" ? "oklch(var(--primary))" : item.category === "egg" ? "#f59e0b" : "oklch(var(--accent))"
                    },
                    title: item.category === "nonveg" ? "Non-Veg" : item.category === "egg" ? "Egg" : "Veg",
                    children: item.category === "nonveg" ? "🔴" : item.category === "egg" ? "🟡" : "🟢"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 flex flex-col flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground leading-snug mb-1 min-w-0", children: item.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed line-clamp-2 flex-1 mb-2", children: item.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-auto", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-primary text-base", children: [
                    "₹",
                    item.price
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: item.category === "nonveg" ? "badge-nonveg" : item.category === "egg" ? "" : "badge-veg",
                      style: item.category === "egg" ? {
                        display: "inline-flex",
                        alignItems: "center",
                        gap: "4px",
                        borderRadius: "9999px",
                      ...
                      children: item.category === "nonveg" ? "Non-Veg" : item.category === "egg" ? "Egg" : "Veg"
                    }
                  )
                ] })
              ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-sm font-semibold uppercase tracking-widest mb-2", children: "Get in Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-4xl font-bold text-foreground mb-2", children: "We're Here to Help" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-md mx-auto text-base", children: "Have a question about our menu or want to place an order? Reach out to us anytime." })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Contact Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-6 space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 18, className: "text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: "tel:9666817773",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 18, className: "text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Opening Hours" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-bold", children: "8:00 AM – 10:00 PM" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Open every day" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 18, className: "text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Location" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-bold", children: "Hyderabad, India" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 18, className: "text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "Quick Reply" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "We respond within a few minutes during opening hours." })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mb-6", children: "Send a Message" }),
        submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 48, className: "text-accent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground", children: "Message Sent!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm", children: [
                "Thank you, ",
                form.name,
                "! We'll get back to you shortly on",
                " ",
                form.phone,
                "."
              ] }),
          ...
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "support-name", className: "text-sm font-semibold", children: "Your Name" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "support-name",
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { page, onNavigate: setPage, children: [
    page === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, { onNavigate: setPage }),
    page === "menu" && /* @__PURE__ */ jsxRuntimeExports.jsx(MenuPage, {}),
    page === "support" && /* @__PURE__ */ jsxRuntimeExports.jsx(SupportPage, {})
  ] });
}
